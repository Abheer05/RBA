...
<head>
    ...
    <title>View Contact Us - Rahbar Badminton Academy</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Contact View</h1>
                    </div>

                    <div class="container mt-3">
                      <h2>Contact Information Table</h2>
                      <p>You can view the information of contact page here and take actions on them.</p>
