...
$result=$fun->get_index_event_image_name();
?>
...
<head>
    ...
    <title>View Index - Event Images - Rahbar Badminton Academy</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Index Event View</h1>
                    </div>

                    <div class="container mt-3">
                      <h2>Index - Event Images Table</h2>
                      <p>You can view the images of event section in index page here and take action on them.</p>
                      <table class="table">
                      ...
                      <div class="text-center">
                            <a class="btn btn-primary" href="index_events_edit.php">Edit</a>
                      </div>
                    </div>
