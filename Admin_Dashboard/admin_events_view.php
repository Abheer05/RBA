...
$result=$fun->get_event_image_name();
?>
...
<head>
    ...
    <title>View Event Images - Rahbar Badminton Academy</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container mt-3">
                      <h2>Event Images Table</h2>
                      <p>You can view the images of event page here and take actions on them.</p>
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><button type="submit" class="btn btn-primary "><a class="text-decoration-none text-white  " href="events_separate_photos_edit.php?srno=<?php echo $arr['srno'];?>">Edit</a></button></td>
                          </tr>
                          <?php $i++; }
                        }?>
                      ...
                      <div class="text-center">
                            <a class="btn btn-primary" href="events_photos_edit.php">Edit Multiple</a>
                      </div>
                    </div>
