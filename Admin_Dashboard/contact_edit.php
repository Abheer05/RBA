...
if(isset($_POST['submit'])){
    ...
    $email=$_POST['email'];
    $social=$_POST['social'];
    $fun-> update_contact_details($srno,$phone,$location,$email,$social);
}
else{
...
<head>
    ...
    <title>Contact Us - Rahbar Badminton Academy</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                        <h1 class="h3 mb-0 text-gray-800">Contact Us Page Editing</h1>
                    </div>
                    <p class="mb-4">Do not use apostrophy(') and double quotaion mark(")</p>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Contact Data Type 1</div>
                                                <div class="h5 input-group mt-2 mb-2 input-group-sm">
                                                  Phone Number
                                                </div>
                                            <div class="h5 font-weight-bold text-gray-800">Information</div>
                                            <div class="input-group mb-3 input-group-lg">
                                                <input type="hidden" class="form-control" placeholder="+91 87676 84625" value="<?php echo $arr['srno'];?>" name="srno">
                                                <input type="text" class="form-control" placeholder="Example : +91 12345 67890" value="<?php echo $arr['phone'];?>" name="phone">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Contact Data Type 2</div>
                                                <div class="h5 input-group mt-2 mb-2 input-group-sm">
                                                  Location
                                                </div>
                                            <div class="h5 font-weight-bold text-gray-800">Information</div>
                                            <div class="input-group mb-1 input-group-lg">
                                                <input type="text" class="form-control" placeholder="Example : Nagpur, Maharastra, India, Asia, Earth"
                                                value="<?php echo $arr['location'];?>" name="location">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Contact Data Type 3</div>
                                                <div class="h5 input-group mt-2 mb-2 input-group-sm">
                                                  E-Mail
                                                </div>
                                            <div class="h5 font-weight-bold text-gray-800">Information</div>
                                            <div class="input-group mb-3 input-group-lg">
                                                <input type="text" class="form-control" placeholder="Example : badmintonacademy@gmail.com" value="<?php echo $arr['email'];?>" name="email">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Contact Data Type 4</div>
                                                <div class="h5 input-group mt-2 mb-2 input-group-sm">
                                                  Social Media
                                                </div>
                                                <div class="h5 font-weight-bold text-gray-800">Information</div>
                                                <div class="input-group mb-3 input-group-lg">
                                                <input type="text" class="form-control" placeholder="Example : @rba2020" value="<?php echo $arr['social'];?>" name="social">
                                            </div>
                                        </div>
                                    </div>
                                </div>
