...
if(isset($_POST['submit'])){
  ...
  header("location:admin_events_view.php");
}
...
<head>
    ...
    <title>Separate Images - Events - Rahbar Badminton Academy</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Event Page Separate Updation</h1>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input name="submit" type="submit" class="btn btn-primary btn-block" value="Upload File">
                                        </div>
                                    </form>
