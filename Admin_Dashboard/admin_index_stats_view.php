...
<head>
    ...
    <title>View Index - Statistics - Rahbar Badminton Academy</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Index - Statistic View</h1>
                    </div>

                    <div class="container mt-3">
                      <h2>Index Statistic Information Table</h2>
                      <p>You can view the information of statistic section in index page here and take actions on them.</p>
                      ...
                      <table class="table">
                        <thead class="table-primary">
                          ...
                          <tr>
                            ...
                            <th scope="col">Statistic Data</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td>1</td>
                            <td><?php echo $arr['sn1'];?></td>
                            <td><?php echo $arr['sd1'];?></td>
                          </tr>
                          <tr>
                            <td>2</td>
                            <td><?php echo $arr['sn2'];?></td>
                            <td><?php echo $arr['sd2'];?></td>
                          </tr>
                          <tr>
                            <td>3</td>
                            <td><?php echo $arr['sn3'];?></td>
                            <td><?php echo $arr['sd3'];?></td>
                          </tr>
                          <tr>
                            <td>4</td>
                            <td><?php echo $arr['sn4'];?></td>
                            <td><?php echo $arr['sd4'];?></td>
                          </tr>
                        </tbody>
                      </table>
                      <div class="text-center text-white text-decoration-none">
