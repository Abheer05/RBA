...
if($_POST['submit'])
{
  ...
  $result = $fun->add_about_image($folder);
...
<head>
    ...
    <title>Carousal - About - Rahbar Badminton Academy</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">About Page Carousal Section Editing</h1>
                    <p class="mb-4">Choose the images to be updated</p>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4 border-bottom-dark">
                                <div class="card-body">
                                    ...
                                    <form action="about_carousal_edit.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="image">Upload Image</label>
                                            <input type="file" class="form-control-file" id="image" name="image" accept="image/*" required><hr>
                                            <button name="submit" type="submit" class="btn btn-primary btn-block" value="Upload File">Add Image</button>
                                        </div>
                                    </form>
